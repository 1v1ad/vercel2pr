...
/**
 * Telegram Login Widget обычно шлёт GET на /callback с query-параметрами.
 * Принимаем и GET, и POST на всякий случай.
 */
router.all('/callback', (req, res) => {
  ...
  // здесь можно создавать пользователя/выдавать JWT
  const front =
